...
Requests recur to add more agent CLIs to Sandcastle's built-in provider set — routing variants of existing tools, or entirely new backends.
...
- New agent integrations ship as userland `AgentProvider` implementations unless they clear the capability bar and justify a standing maintenance commitment.
- See ADR 0023 for the parallel decision on sandbox providers.
